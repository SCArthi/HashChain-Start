            ...
            <ul class="nav metismenu" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        ...
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            ...
                            <li><a class="dropdown-item" href="<?php echo base_url('Login/superadminlogin');?>">Logout</a></li>
                        </ul>
                    </div>
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        <li><a href="<?php echo base_url('Dashboard/superadmindashboard');?>">Super Admin Dashboard</a></li>
                        <li><a href="<?php echo base_url('Dashboard/admindashboard');?>">Admin Dashboard</a></li>
                        <li><a href="<?php echo base_url('Dashboard/userdashboard');?>">User Dashboard</a></li>
                    </ul>
                </li>
            </ul>
        </div>
    ...
    <div id="page-wrapper" class="gray-bg sidebar-content">
        ...
        <div class="navbar-header">
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li>
                    <span class="m-r-sm text-muted welcome-message">Welcome to Super Admin Page</span>
                </li>
                <li class="dropdown">
                ...
                <li>
                    <a href="<?php echo base_url('Login/superadminlogin');?>">
